    ...
    return (
        <div>
            ...
            <div>
                ...
                <p
                    className={`clickable ${
                        selectedItemDetail?.type === "size" && selectedItemDetail.id === Number(popularItems.mostPopularSize?.[0])
                            ? "selected"
                            : ""
                    }`}
                    onClick={() =>
                ...
                <p
                    className={`clickable ${
                        selectedItemDetail?.type === "cheese" && selectedItemDetail.id === Number(popularItems.mostPopularCheese?.[0])
                            ? "selected"
                            : ""
                    }`}
                    onClick={() =>
                ...
                <p
                    className={`clickable ${
                        selectedItemDetail?.type === "sauce" && selectedItemDetail.id === Number(popularItems.mostPopularSauce?.[0])
                            ? "selected"
                            : ""
                    }`}
                    onClick={() =>
                ...
                <ul>
                    {popularItems.topToppings?.map(([toppingId, count]) => (
                        <li
                            key={toppingId}
                            className={`clickable ${
                                selectedItemDetail?.type === "topping" && selectedItemDetail.id === Number(toppingId)
                                    ? "selected"
                                    : ""
                            }`}
                            onClick={() =>
